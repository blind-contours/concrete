---
title: "Reference walkthrough"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Reference walkthrough}
...
`survival::pbc` data, including a joint-intervention example. New users should
start with the [Trialist quickstart](trialist-quickstart.html); this article is
a fuller tour of the available options.
